...
if [ -f "$STAGE5_CHECKPOINT" ]; then
    ...
    echo
    # 跳转到 ALL_COMPLETED
    goto_all_completed=1
else
    goto_all_completed=0
fi

if [ $goto_all_completed -eq 0 ]; then
